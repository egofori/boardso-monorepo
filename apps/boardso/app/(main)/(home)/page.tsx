  ...
  return (
    <>
      <div className="h-[500px] flex justify-center items-center flex-col gap-5 bg-hero-image bg-no-repeat bg-cover bg-center relative" >
        ...
        <UIButton onClick={() => router.push("add-billboard") } size="md" className="text-white bg-tertiary-200/50 hover:bg-tertiary-200/60 rounded-full z-[1] text-lg font-medium flex items-center">
